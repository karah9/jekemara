<x-filament-panels::page>
    <livewire:rapport.header-rapport/>
    <table>
        ...
        <tr class="border border-slate-400">
            ...
            <td class="py-4 px-6  border border-slate-400">
                {{$infrastructure->typeInfrastructure->nom}}
            </td>
        </tr>
        <tr class="border border-slate-400">
            <td class="py-4 px-6 uppercase font-bold">
            ...
            <td class="py-4 px-6  border border-slate-400">
                {{$infrastructure->superficie ?? $infrastructure->volume}}
            </td>
        </tr>
        <tr class="border border-slate-400">
            <td class="py-4 px-6 uppercase font-bold">
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 py-5">
        ...
        <tr class="text-lg font-bold text-red-600">
            ...
            <td class="py-4 px-6">
                {{round($lastPdc->biomasse / $cycle->alimentations->sum('produit'))}} Kg
            </td>
        </tr>
        </tbody>
    </table>
