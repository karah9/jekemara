<x-filament-panels::page>
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 py-5 border-collapse border border-slate-400 rounded-md">
        ...
        <tr class="border border-slate-400 font-bold uppercase">
            <td class="py-4 px-6 border border-slate-400 uppercase font-bold" rowspan="{{count($aliments) * 2 + count($especes)+ 1}}">Quantité totale d'aliment utilisé</td>
        </tr>
        @foreach($this->especes as $espece)

            <tr class="border border-slate-400 font-bold uppercase">
                <td class="py-4 px-6 border border-slate-400 uppercase font-bold" rowspan="3"> {{$espece}}</td>
            </tr>
